...
public class Controller implements Initializable{
    ...
    */
    static String KnowledgeBase[][][] = {
            ...
            {{"ARE YOU INTELLIGENT", "ARE YOU SMART"},
                    {"YES,OFCORSE.",
                            "WHAT DO YOU THINK?",
                            "ACTUALY,I'M VERY INTELLIGENT!"}
            },

            {{"ARE YOU REAL", "ARE YOU BOT", "ARE YOU A ROBOT"},
            ...
            {{"IAM SAD","I AM SAD", "I FEEL SAD"},
                    {"WHY ARE YOU SAD",
                            "DON'T WORRY AND BE HAPPY (BOB MARLEY)",
                            "DON'T BE SAD",}
            },

            {{"IAM HAPPY", "I AM HAPPY", "I FEEL HAPPY"},
                    {"WHY ARE YOU HAPPY",
                            "IT'S GOOD FOR YOU",
                            "I AM HAPPY TOO",}
            },
    ...
    public void get_input() throws Exception {
        ...
        save_prev_input();
        sInput = textField.getText();
        Label userInput = new Label(sInput);
        userInput.setStyle((
    ...
    public  void print_response() {
        if (sResponse.length() > 0) {
            sInput = textField.getText();
            Label botRespond = new Label(sResponse);
            botRespond.setStyle((
            ...
            //Print the respond
            vBox.getChildren().add(botRespond);
            //Speaking
            /*
            voice.say(sResponse);
            */
    ...
    void logoClicked(MouseEvent event) {
        ...
        try {
            FXMLLoader chat = new FXMLLoader(getClass().getResource("sample.fxml"));
            Parent root = chat.load();
            Stage stage = new Stage();
            stage.setTitle("Chat");
            stage.setScene(new Scene(root, 427, 482));
    ...
    @FXML
    void textFieldClicked(ActionEvent event) {
